...
// ── CSV Export ─────────────────────────────────────────────
export function exportCSV(transactions, filename = 'Hisba-transactions') {
...
// ── Excel Export ───────────────────────────────────────────
export function exportExcel(transactions, summary, filename = 'Hisba-report', categories = []) {
  const arabic = getLanguage().startsWith('ar');
...
<head>
<meta charset="UTF-8">
<title>Hisba — Financial Report</title>
<style>
...
<body>
  <div class="header">
    <div>
      <div class="brand"><img src="assets/hisba-logo.png" alt="Hisba"><span>حِسبة</span></div>
  ...
  <div class="footer">Generated by Hisba • ${new Date().toLocaleDateString()} • Hisba.app</div>
</body>
</html>`;
}
...
<head>
<meta charset="UTF-8">
<title>Hisba — Corporate Report</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
...
<body>
  ...
  <div class="footer">Hisba Financial Report — ${period} — Generated ${new Date().toLocaleDateString()}</div>
</body>
</html>`;
}
...
<head>
<meta charset="UTF-8">
<title>Hisba — Modern Report</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
...
<body>
  <div class="hero">
    <div class="hero-brand"><img src="assets/hisba-logo.png" alt="Hisba"><span>حِسبة</span></div>
  ...
  <div class="footer">Hisba • ${new Date().toLocaleDateString()} • Hisba.app</div>
</body>
</html>`;
}
...
<head>
<meta charset="UTF-8">
<title>Hisba — Dark Premium Report</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
...
<body>
  ...
  <div class="footer">Generated by Hisba • ${new Date().toLocaleDateString()}</div>
</body>
</html>`;
}
