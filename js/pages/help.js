/* ============================================================
   ...
   ============================================================ */
import { getLanguage, renderIcon } from '../utils.js?v=release-2.3.0';
...
const content = {
  ...
  en: {
    ...
    sub: 'Hisbba is more than an expense log. It helps you understand where your money goes and make calmer, clearer decisions.',
    flowTitle: 'Hisbba in one minute',
    ...
    ruleText: 'As soon as you spend or receive money, record it in Hisbba before you forget. Small expenses matter too; repeated small amounts can change the whole month.',
    ruleAction: 'Record your first transaction',
    journeyTitle: 'Your Hisbba journey, step by step',
    journeySub: 'You do not need to change every habit at once. Start small and let Hisbba help you stay consistent.',
    steps: [
      ...
      ['04', 'Set a realistic budget', 'Choose one or more categories and set a monthly amount. Hisbba alerts you as you approach or exceed the limit.', 'budgets', 'Create a budget'],
    ...
    benefitTitle: 'How does Hisbba help you?',
    benefits: [
    ...
    faq: [
      ['Do I need to record very small expenses?', 'Yes. That is one of the most important habits in Hisbba. Small repeated expenses can become a large part of your spending, so record them before you forget.'],
      ['What if I forgot to record an expense?', 'Record it as soon as you remember and add the correct date and description. If it happens often, open Hisbba immediately after a purchase and make it a short habit.'],
    ...
    quoteBy: 'Today’s Hisbba message',
